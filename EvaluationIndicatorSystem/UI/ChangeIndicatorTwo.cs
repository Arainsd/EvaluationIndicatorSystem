...
namespace EvaluationIndicatorSystem
{
    ...
    {
        public ChangeIndicatorTwo(Dictionary<string, BasicDataModule> data, params BasicDataModule[] module)
        {
            InitializeComponent();
            ...
            if (module.Length > 0)
            {
                this.comb_one.SelectedItem = modules[module[0].ParentId.ToString()].Name;
